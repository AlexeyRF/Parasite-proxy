...
Для Windows (требуется установленный Nmap/Ncat):
```powershell
ssh -o ProxyCommand="ncat --proxy-type socks5 --proxy BRIDGE_IP:1080 --proxy-auth user:pass %h %p" username_на_воркере@127.0.0.1
```
